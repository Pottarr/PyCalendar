...
class HomePage(Page) :
    ...
    def __init__(self, root, login_result) :
        ...
        self.padding_frame = CTkFrame(self.page_frame, fg_color = alphabet_blue, bg_color = alphabet_blue,
                                      border_color = "purple", border_width = 5)
        ...
        self.activity_log_frame = CTkFrame(self.padding_frame, fg_color = python_blue_lighter,
                                           border_color = python_blue, border_width = 5)
        ...
        self.activity_log_frame.grid_rowconfigure(2, weight = 1)
        ...
        self.activity_log_list = ActivityLogListWidget(self.activity_log_frame, self.current_user, self.current_date)
        self.activity_log_list.grid(row = 1, column = 0, sticky = "nsew", padx = 20, pady = 10)
