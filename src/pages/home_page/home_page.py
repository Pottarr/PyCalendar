...
class HomePage(Page) :
    ...
    def display_activity_log(self, caller = None) :
        if caller == "not none" :            
            ...
            self.activity_log_list_widget = ActivityLogListWidget(self.activity_log_frame, self,
                                                                  self.current_user, self.current_date,
                                                                  self.current_day_of_week, self.file_obj)
    ...
    def display_add_activity(self) :
        ...
        self.add_activity_widget = AddActivityWidget(self.activity_log_frame, self, self.current_user,
                                                     self.current_date, self.file_obj)
