...
class HomePage:
    def __init__(self, root):
        ...
        self.page_frame = tk.Frame(self.root, bg = trueman_green, padx = 50, pady = 50)
        ...
        self.home_label = tk.Label(self.page_frame, text = "HOME PAGE")
        # self.home_label.grid(row = 0, column = 0, columnspan = 9)
        self.home_label.grid(row = 0, column = 0, columnspan = 16)
        
        self.calendar_frame = tk.Frame(self.page_frame, bg = alphabet_blue)
        ...
        self.activity_log_frame = tk.Frame(self.page_frame, bg = alphabet_blue)
        ...
        # self.edit_activity_frame = tk.Frame(self.page_frame, bg = cutie_pink)